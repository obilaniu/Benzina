/* Include Guard */
#ifndef SRC_BENZINA__NATIVE__C_BENZINAOBJECTS_H
#define SRC_BENZINA__NATIVE__C_BENZINAOBJECTS_H
...
struct BenzinaFileViewObject{
    #define BenzinaFileViewObject_HEAD                                                \
        BenzinaViewObject_HEAD                                                        \
        Py_ssize_t               fd;         /* Unix: File Descriptor (int) */        \
        PyObject*                __dict__;                                            \
        PyObject*                __weakref__;
    
    BenzinaFileViewObject_HEAD
};
#endif
