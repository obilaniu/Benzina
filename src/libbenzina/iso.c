...
BENZINA_PUBLIC BENZINA_EXTERN_INLINE int         benz_iso_box_is_type             (BENZ_BOX    p, const void* type);
BENZINA_PUBLIC BENZINA_EXTERN_INLINE const char* benz_iso_box_get_exttype         (BENZ_BOX    p);
BENZINA_PUBLIC BENZINA_EXTERN_INLINE const void* benz_iso_box_get_payload         (BENZ_BOX    p);
...
BENZINA_PUBLIC BENZINA_EXTERN_INLINE int         benz_iso_fullbox_is_type         (BENZ_BOX    p, const void* type);
...
BENZINA_PUBLIC BENZINA_EXTERN_INLINE const void* benz_iso_fullbox_get_payload     (BENZ_BOX    p);
